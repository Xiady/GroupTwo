...
public class MyXinPinAdapter extends BaseAdapter {
	List<Productlist> productlist;
	Context context;

	public MyXinPinAdapter(Context context, List<Productlist> productlist) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			convertView = View.inflate(context, R.layout.xinpin_item, null);
