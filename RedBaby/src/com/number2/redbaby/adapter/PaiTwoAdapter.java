...
public class PaiTwoAdapter extends BaseAdapter {
	Context context;
	List<Pai_Category> list;

	public PaiTwoAdapter(Context context, List<Pai_Category> list) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		View view = View.inflate(context, R.layout.pai_two_lv_item, null);
