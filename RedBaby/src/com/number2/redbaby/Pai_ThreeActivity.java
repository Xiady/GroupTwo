 ...
 * @Date 2016/09/02
 */
public class Pai_ThreeActivity extends Activity {
	...
	private void setListener() {
		pai_lv.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
					long arg3) {
				Intent intent = new Intent(Pai_ThreeActivity.this,
	...
	private void initData() {
		...
		util.Get("category?version=" + pai_versionCode, new VolleyCallBack() {
			...
			public void setDataFromVolley(String json) {
				...
				pai_lv.setAdapter(new PaiTwoAdapter(Pai_ThreeActivity.this,
						newCategory));
			}
		});
	}
